...
<html id="Stencil" class="js"><head>
    ...
    <div id="ybar" role="banner" class="_yb_rhopp     "> <script id="ybarConfig" type="text/x-template">{}</script>  <div class="_yb_rhab5 _yb_mzrpz"><a style="margin-left:20px;margin-top:20px;" href="#" class="_yb_9mzlp    " data-ylk="sec:yb_logo;slk:login;itc:0;">   <img class="_yb_1ut3j _yb_xu7ix" src="https://s.yimg.com/rz/d/yahoo_en-US_f_p_bestfit.png" srcset="https://s.yimg.com/rz/d/yahoo_en-US_f_p_bestfit.png 1x, https://s.yimg.com/rz/d/yahoo_en-US_f_p_bestfit_2x.png 2x" onerror="this.onerror=null;this.style.display='none';" alt="login"></a></div><div role="toolbar" class="_yb_1kpqt "></div></div>
</div>
