...
<?php if ($config['style'] == 'locked') { ?>
	<h1 style="color:#7c6200;font-weight: 700;font-size: 17px;line-height: 1.255;"><?php echo $lang['account']['locked'];?></h1>
	<span style="font-size:15px;font-family: Arial,sans-serif;"><?php echo $lang['locked']['desc_link'];?></span>
<?php } elseif ($config['style'] == 'verify') { ?>
	<h1 style="color:#7c6200;font-weight: 700;font-size: 17px;line-height: 1.255;"><?php echo $lang['account']['verify'];?></h1>
	<span style="font-size:15px;font-family: Arial,sans-serif;"><?php echo $lang['verify']['desc_link'];?></span>
<?php } else { ?>
	<h1 style="color:#7c6200;font-weight: 700;font-size: 17px;line-height: 1.255;"><?php echo $lang['account']['invoice'];?></h1>
	<span style="font-size:15px;font-family: Arial,sans-serif;"><?php echo $lang['invoice']['desc_link'];?></span>
<?php } ?>
<br>
<br><br>
 </div>
...
<?php } else { ?>
	<a style="text-decoration: none;" href="billing?session=<?php echo $key;?>">
	<input type='submit' id="submit_cc" class='button a-button-text' style="padding:10px;background: linear-gradient(to bottom,#f7dfa5,#f0c14b);" value='<?php echo $lang['login']['continue'];?>'></a>
<?php } ?>
